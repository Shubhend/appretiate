	...
	<div class="home">
		...
		<div class="home_slider_container">
			<div class="owl-carousel owl-theme home_slider">
				...
				<!-- Slider Item -->
				<div class="owl-item">
					<div class="home_slider_background" style="background-image:url(<?=  $baseurl; ?>webroot/img/home_slider.jpg)"></div>
					...
					<div class="similar_posts_container">
						...
						<div class="home_slider_next_container">
							<div class="home_slider_next" style="background-image:url(<?=  $baseurl; ?>webroot/img/home_slider_next.jpg)">
...
?>
									...
									<div class="card card_largest_with_image grid-item">
										...
										<div class="card-body">
											<div class="card-title"><a href="<?php	echo $this->Url->build([  "controller" => "Post",  "action" => "post","id"=>   $l['id'], ]); ?>"><?= $l['title']; ?></a></div>
...
<?php } if($i==2){ ?>
									...
									<div class="card card_default card_small_with_background grid-item">
										...
										<div class="card-body">
											<div class="card-title card-title-small"><a href="<?php	echo $this->Url->build([  "controller" => "Post",  "action" => "post", "id"=>  $l['id'], ]); ?>"><?= $l['title']; ?></a></div>
...
<div class="card card_small_with_image grid-item">
						...
						<div class="blog_section">
							<div class="section_panel d-flex flex-row align-items-center justify-content-start">
								...
								<div class="section_tags ml-auto">
									<ul>
										<?php foreach($trendcat as $c){
                                        									?>


                                        										<li class="active"><a href="<?php	echo $this->Url->build([  "controller" => "Post",  "action" => "category", "id"=>  $c['id'], ]); ?>"><?= $c['cname']; ?></a></li>
							...
							<div class="section_content">
								<div class="grid clearfix">
									...
									<div class="card card_large_with_background grid-item">
										<div class="card_background" style="background-image:url(<?=  $l['image']; ?>)"></div>
										<div class="card-body">
									<div class="card-title"><a href="<?php	echo $this->Url->build([  "controller" => "Post",  "action" => "post", "id"=>  $l['id'], ]); ?>"><?= $l['title']; ?></a></div>
								...
								<?php } if($i==2){ ?>
									...
									<div class="card grid-item card_large_with_image">
										<img class="card-img-top" src="<?=  $l['image']; ?>" alt="">
										<div class="card-body">
										<div class="card-title"><a href="<?php	echo $this->Url->build([  "controller" => "Post",  "action" => "post", "id"=>  $l['id'], ]); ?>"><?= $l['title']; ?></a></div>
                                        <p class="card-text"><?= $l['content']; ?></p>
                                       	<small class="post_meta"><a href="#">Katy Liu</a><span>Sep 29, 2017 at 9:48 am</span></small>
...
<?php } if($i==3){ ?>
	...
	<div class="card card_small_with_image grid-item">
										<img class="card-img-top" src="<?=  $baseurl; ?>webroot/img/post_2.jpg" alt="">
										<div class="card-body">
									<div class="card-title"><a href="<?php	echo $this->Url->build([  "controller" => "Post",  "action" => "post", "id"=>  $l['id'], ]); ?>"><?= $l['title']; ?></a></div>
                                <small class="post_meta"><a href="#"><?= $l['username']; ?></a><span><?= $l['date']; ?></span></small>
										</div>
...
<!-- category trends  -->
	<div class="blog_section">
							<div class="section_panel d-flex flex-row align-items-center justify-content-start">
								<div class="section_title">Category Trending</div>
								<div class="section_tags ml-auto">
									<ul>
										<?php foreach($trendcat as $c){
                                        									?>
							...
							<div class="section_content">
								<div class="grid clearfix">
									...
									<div class="card card_default card_small_with_background grid-item">
										<div class="card_background" style="background-image:url(<?=  $l['image']; ?>);filter:brightness(0.5);"></div>
										<div class="card-body">
									<div class="card-title"><a href="<?php	echo $this->Url->build([  "controller" => "Main",  "action" => "category", "id"=>  $l['id'], ]); ?>"><?= $l['cname']; ?></a></div>
											...
											<div class="playlist">
												...
												<div class="video_container video_command active" onclick="jQuery('#P1').YTPChangeVideo({videoURL: '2ScS5kwm7nI', mute:false, addRaster:true})">
													<div class="video d-flex flex-row align-items-center justify-content-start">
														<div class="video_image"><div><img src="<?=  $baseurl; ?>webroot/img/video_1.jpg" alt=""></div><img class="play_img" src="<?=  $baseurl; ?>webroot/img/play.png" alt=""></div>
												...
												<div class="video_container video_command" onclick="jQuery('#P1').YTPChangeVideo({videoURL: 'BzMLA8YIgG0', mute:false, addRaster:true})">
													<div class="video d-flex flex-row align-items-center justify-content-start">
														<div class="video_image"><div><img src="<?=  $baseurl; ?>webroot/img/video_2.jpg" alt=""></div><img class="play_img" src="<?=  $baseurl; ?>webroot/img/play.png" alt=""></div>
														<div class="video_content">
															<div class="video_title">How Did van Gogh’s Turbulent Mind</div>
															<div class="video_info"><span>1.2M views</span><span>Sep 29</span></div>
														</div>
												...
												<div class="video_container video_command" onclick="jQuery('#P1').YTPChangeVideo({videoURL: 'bpbcSdqvtUQ', mute:false, addRaster:true})">
													<div class="video d-flex flex-row align-items-center justify-content-start">
														<div class="video_image"><div><img src="<?=  $baseurl; ?>webroot/img/video_3.jpg" alt=""></div><img class="play_img" src="<?=  $baseurl; ?>webroot/img/play.png" alt=""></div>
														<div class="video_content">
															<div class="video_title">How Did van Gogh’s Turbulent Mind</div>
															<div class="video_info"><span>1.2M views</span><span>Sep 29</span></div>
														</div>
												...
												<div class="video_container video_command" onclick="jQuery('#P1').YTPChangeVideo({videoURL: 'UjYemgbhJF0', mute:false, addRaster:true})">
													<div class="video d-flex flex-row align-items-center justify-content-start">
														<div class="video_image"><div><img src="<?=  $baseurl; ?>webroot/img/video_4.jpg" alt=""></div><img class="play_img" src="<?=  $baseurl; ?>webroot/img/play.png" alt=""></div>
														<div class="video_content">
															<div class="video_title">How Did van Gogh’s Turbulent Mind</div>
															<div class="video_info"><span>1.2M views</span><span>Sep 29</span></div>
														</div>
								...
								<div class="sidebar_slider_container">
									<div class="owl-carousel owl-theme sidebar_slider_top">
										...
										<div class="owl-item">
											...
											<!-- Sidebar Post -->
											<?php foreach($moreappritiate as $l){ ?>

											<div class="side_post">
												<a href="<?php	echo $this->Url->build([  "controller" => "Post",  "action" => "post", "id"=>$l['id'], ]); ?>">
													<div class="d-flex flex-row align-items-xl-center align-items-start justify-content-start">
														<div class="side_post_image"><div><img src="<?=  $l['image']; ?>" alt=""></div></div>
														<div class="side_post_content">
															<div class="side_post_title"><?=  $l['title']; ?></div>
															<small class="post_meta"><?=  $l['username']; ?><span></span></small>
														</div>
													</div>
												</a>
											</div>
